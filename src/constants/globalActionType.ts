export enum GlobalActionType {
    ...
    PROGRESS_CHANGE_WITH_KEY = 'PROGRESS_CHANGE_WITH_KEY',
    ...
    HIDE_MESSAG_BY_REFERENCE = 'HIDE_MESSAG_BY_REFERENCE',
    SHOW_MESSAGE_BY_REFERENCE = 'SHOW_MESSAGE_BY_REFERENCE',
    ...
    LOAD_TWITTER_MEDIA = 'LOAD_TWITTER_MEDIA',
