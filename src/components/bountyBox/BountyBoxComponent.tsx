...
const translateWrraper = withTranslation('translations')(BountyBoxComponent as any)

export default connect(mapStateToProps, mapDispatchToProps)(withStyles(bountyBoxStyles as any) (translateWrraper as any))
