 ...
 */
const mapDispatchToProps = (dispatch: any, ownProps: IPhotoAlbumProps) => {
  return {
    search:
...
const makeMapStateToProps = () => {
  ...
  const mapStateToProps = (state: Map<string, any>, ownProps: IPhotoAlbumProps) => {
...
export const connectPhotoAlbum =
  (component: Component<IPhotoAlbumProps>) => connect(makeMapStateToProps, mapDispatchToProps)(component as any)